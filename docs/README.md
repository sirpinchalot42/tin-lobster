...
Tin Lobster documentation uses three main manuals plus small how-tos.
...
- [SSH access](how-to/ssh.md) — Windows, macOS, Android
- [Remote access](how-to/remote-access.md) — Tailscale
...
1. README (what it is)
2. Design guide (how it fits together)
3. User manual (do the install)
4. Admin guide (keep it healthy / fix it)
